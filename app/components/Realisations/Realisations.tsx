...
export default function Realisations() {
  ...
  useGSAP(() => {
    ...
    const build = (opts: { bulletSel: string; cardSel: string }) => {
      ...
      cards.forEach((card, i) => {
        ...
        tl.to(
          card,
          { autoAlpha: 1, x: 0, y: 0, duration: 0.1, ease: "power2.out" },
    ...
    return () => {
      counterTween.scrollTrigger?.kill();
      counterTween.kill();
      mm.revert();
    };
  }, []);
  ...
  return (
    <section id="realisations" className="bg-(--color-brand-900) text-(--overlayText)">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 md:px-8 md:py-20">
        ...
        <div className="relative mt-12">
          {/* ✅ TIMELINE WRAPPER : ligne = du début de la liste jusqu'à la fin de la liste */}
          ...
          {/* ✅ Final box OUTSIDE the timeline wrapper -> la ligne s’arrête à la fin des cards */}
